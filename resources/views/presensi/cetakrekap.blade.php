...
<body class="A4 landscape">
    ...
    <section class="sheet padding-10mm">
        ...
        <table style="width: 100%">
            <tr>
                <td style="width: 30px">
                    <img src="{{ asset('assets/img/Bursel Ok.png') }}" width="70" height="70" alt="">
                </td>
                <td>
                    <span id="title">
                        REKAP PRESENSI PEGAWAI<br>
                        PERIODE {{ strtoupper($namabulan[$bulan]) }} {{ $tahun }}<br>
                        DINAS KOMUNIKASI DAN INFORMATIKA BURU SELATAN<br>
                    </span>
                    <span><i>Jln. Mangga Dua Kecamatan Namrole, Kabupaten Buru Selatan</i></span>
                </td>
            </tr>
        </table>
        ...
        <table width="100%" style="margin-top:100px">
            <tr>
                <td></td>
                <td style="text-align: center">Namrole, {{ date('d-m-Y') }}</td>
            </tr>
            <tr>
                <td style="text-align: center; vertical-align:bottom" height="100px">
                    <u>YUSUF S. WALLY</u><br>
                    <i><b>KEPALA SUB KEPEGAWAIAN</b></i>
                </td>
